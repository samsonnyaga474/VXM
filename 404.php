...
<head>
  ...
  <title>Page not found | VXM</title>
...
<body>
  <div class="auth-page">
    <div class="auth-card" style="text-align:center;">
      ...
      <h1 style="font-size:3rem;margin:1rem 0 0.5rem;color:var(--accent);">404</h1>
      <h2 style="font-size:1.25rem;margin-bottom:0.75rem;">Page not found</h2>
